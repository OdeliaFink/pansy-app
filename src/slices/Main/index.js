    ...
    >
      <div className="relative isolate w-full h-[30rem] sm:h-[28rem] md:h-[32rem] lg:h-[36rem] xl:h-[40rem] 2xl:h-[50rem] overflow-hidden">
        ...
        <PrismicNextImage
          ...
          className="w-full h-full object-cover md:object-[left_70%] md:object-[30%_center] xl:object-[30%_60%]"
        />
        ...
        <div className="absolute inset-0 z-[20] ml-4 flex justify-start">
          <div className="text-left relative top-[14rem] leading-none px-4 min-[1536px]:top-[20rem]">
