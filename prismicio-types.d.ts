...
interface CookieDocumentData {
  /**
   * Heading field in *Cookie*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: cookie.heading
   * - **Tab**: Main
  ...
  /**
   * Button field in *Cookie*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: cookie.button
   * - **Tab**: Main
  ...
  /**
   * Button_2 field in *Cookie*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: cookie.button_2
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  button_2: prismic.LinkField;
}
...
export interface BannerSliceDefaultPrimary {
  ...
  /**
   * Link Text field in *Banner → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: banner.primary.link_text
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
export interface ContactFormSliceDefaultPrimary {
  /**
   * First name field in *ContactForm → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: contact_form.primary.first_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  first_name: prismic.KeyTextField;

  /**
   * Last name field in *ContactForm → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: contact_form.primary.last_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  ...
  /**
   * Service options field in *ContactForm → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: contact_form.primary.service_options
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  service_options: prismic.SelectField<
    "Design & Planning" | "Gardening" | "Maintenance"
  >;

  /**
   * Postal code field in *ContactForm → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: contact_form.primary.postal_code
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  postal_code: prismic.KeyTextField;

  /**
   * Comments field in *ContactForm → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: contact_form.primary.comments
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
export interface PhotoGallerySliceDefaultPrimary {
  ...
  /**
   * Image11 field in *PhotoGallery → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: photo_gallery.primary.image11
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image11: prismic.ImageField<never>;

  /**
   * Image12 field in *PhotoGallery → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: photo_gallery.primary.image12
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image12: prismic.ImageField<never>;
}
